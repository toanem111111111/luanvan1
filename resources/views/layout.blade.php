...
<head>
    ...
    <title>Shop Nguyen Xuan Toan</title>
                    ...
                    <div class="col-sm-6">
                        <div class="contactinfo">
                            <ul class="nav nav-pills">
                                <li><a href="#"><i class="fa fa-phone"></i> 0975618061</a></li>
                                <li><a href="#"><i class="fa fa-envelope"></i> toannguyen260300@gmail.com</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-sm-6">
                    ...
                    <div class="col-sm-8">
                        <div class="shop-menu pull-right">
                            <ul class="nav navbar-nav">
                                ...
                                <?php
                                 }elseif($id_customer!=NULL && $id_shipping!=NULL){
                                 ?>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-5">
                        ...
                        <div class="search_box pull-right">
                            ...
                            <button type="submit" style="margin-top:0;color:#666" name="search_items" class="btn btn-primary btn-sm" >Tìm kiếm</button>
                        </div>
                        </form>
                    </div>
                </div>
    ...
    <section id="slider" ><!--slider-->
        <div class="container">
            <div class="row">
                ...
                <img src="{{('public/frontend/images/hinhnenn.jpg')}}" class="girl img-responsive" alt="" />
                        ...
                        <div class="brands_products"><!--brands_products-->
                            ...
                            <div class="brands-name">
                                <ul class="nav nav-pills nav-stacked">
                                    @foreach($brand as $key => $pro_bra)
                                        <li><a href="{{url('thuong-hieu/'.$pro_bra->id)}}"> <span class="pull-right"></span>{{$pro_bra->name_brand}}</a></li>
                                    @endforeach
                                </ul>
                            </div>
                        </div><!--/brands_products-->
